...
const content = '<p>This is an previous plan that I may last weekend</p>';
...
export default function EditPlan() {
  ...
  const [value, setValue] = useState<Date | null>(new Date(2025, 3, 27));
  ...
  return (
    <Container fluid>
      <Group justify='space-between' align='center'>
        <Title order={1} mt={25} mb={15}>Edit Lesson Plan</Title>
        <Group>
      ...
      <Grid>
        ...
        <Grid.Col span={12}>
          ...
          <Textarea
            ...
            autosize
            value={'Make sure to check back later on Monday'}
            minRows={2}
            maxRows={10}
          />
        </Grid.Col>
